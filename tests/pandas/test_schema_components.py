...
def test_multi_index_failure_cases_show_full_tuples() -> None:
    ...
    This is a regression test for backward compatibility with pandera 0.25.
    In 0.25, the 'index' column in failure_cases contained full MultiIndex
    tuples as strings (e.g., "('c', 3)"). This was broken in 0.26+ where it
    showed just the level value (e.g., 'c').
    """
